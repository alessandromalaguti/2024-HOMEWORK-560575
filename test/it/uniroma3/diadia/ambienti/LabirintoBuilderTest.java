...
public class LabirintoBuilderTest {
	...
	public void testBilocale() {
		Labirinto bilocale = labirintoBuilder
				...
				.getLabirinto();
		assertEquals(bilocale.getStanzaFinale(),bilocale.getStanzaCorrente().getStanzaAdiacente("nord"));
	...
	public void testLabirintoConStanzaMagica_AggiuntaElementoOltreSogliaMagica() {
		...
		assertEquals(new Attrezzo(nomeAttrezzo2Inv,peso2_x2).getPeso(), listaStanze.get(nomeStanzaMagica).getAttrezzo(nomeAttrezzo2Inv).getPeso());
		assertEquals(new Attrezzo(nomeAttrezzo1,peso1).getNome(), listaStanze.get(nomeStanzaMagica).getAttrezzo(nomeAttrezzo1).getNome());
		assertEquals(new Attrezzo(nomeAttrezzo1,peso1).getPeso(), listaStanze.get(nomeStanzaMagica).getAttrezzo(nomeAttrezzo1).getPeso());
	}
